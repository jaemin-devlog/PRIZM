...
- [x] ORIENT: 최종 main·기존 tag/Release·CI·배포 경계·PRZ-002 Gate 확인
- [x] SPEC: `v1.0.0` source-only 범위·비범위·완료 조건 고정
- [x] PLAN: 보안 운영·버전·SBOM·검증·PR·tag·Release 순서 고정
- [x] IMPLEMENT: Private Vulnerability Reporting 활성화와 실제 상태 확인
- [x] IMPLEMENT: SECURITY·SUPPORT·유지관리 정책·Issue/PR template 정리
- [x] IMPLEMENT: backend/frontend `1.0.0`과 SBOM·checksum 동기화
