...
| 통합선 기준 HEAD | `PRZ-040-search-v3-shadow-indexing-worker@ded1adb4002e904eb4b5652db556faa9a0d6f8a2` |
| 현재 검증 branch | `PRZ-041-search-v3-runtime-completion` |
...
| Shadow indexing Worker | PRZ-040 `SHADOW_INDEXING_WORKER_READY` |
| Shadow runtime | PRZ-041 `SEARCH_V3_RUNTIME_READY` |
...
| [PRZ-040](../PRZ-040-search-v3-shadow-indexing-worker/evidence.md) | 실제 원문에서 B3 구조·두 embedding 계열을 만들어 저장·READY·shadow activation | `SHADOW_INDEXING_WORKER_READY` |
| [PRZ-041](../PRZ-041-search-v3-runtime-completion/evidence.md) | 자동 dispatch·recovery와 ACTIVE-only shadow query, 실제 BGE-M3 smoke | `SEARCH_V3_RUNTIME_READY` |
                                 ...
                                 └─ PRZ-037  SHADOW_STORAGE_READY
                                     └─ PRZ-038  JOB_FENCING_READY
                                        └─ PRZ-039  INVENTORY_ACTIVATION_READY
                                           └─ PRZ-040  SHADOW_INDEXING_WORKER_READY ← refactor/search-v3@ded1adb
                                              └─ PRZ-041  SEARCH_V3_RUNTIME_READY
```
