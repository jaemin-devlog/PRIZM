...
| PRZ&#8209;030 | [Search V3 Semantic Evidence Validation Ceiling](PRZ-030-semantic-evidence-validation-ceiling/spec.md) | `IN_PROGRESS` | [근거](PRZ-030-semantic-evidence-validation-ceiling/evidence.md) |
