...
| PRZ&#8209;029 | [Search V3 Evidence Validation과 Selection](PRZ-029-evidence-validation-selection/spec.md) | `IN_PROGRESS` | [근거](PRZ-029-evidence-validation-selection/evidence.md) |
