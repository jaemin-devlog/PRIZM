...
버그 제보, 문서 개선과 재현 가능한 검증 보완을 환영합니다. `버그 보고`, `기능 제안`,
`문서 개선` Issue Form 중 맞는 양식을 사용해 주세요. 새로운 제품
기능은 먼저 Issue에서 범위와 필요성을 논의해 주세요. 일반 문의 범위는
[지원 정책](SUPPORT.md), 운영 결정은 [유지관리 정책](MAINTAINERS.md)을 따릅니다.
...
1. 기존 Issue를 확인하고, 새 문제라면 알맞은 Issue Form에 재현 방법이나 제안 배경을 적습니다.
...
[행동 강령](CODE_OF_CONDUCT.md)을 지켜 주세요. 취약점이나 민감한 정보는 공개하지
말고 [보안 정책](SECURITY.md)의 Private Vulnerability Reporting 절차를 따라 주세요.
